...
/******************************* Color Picker *******************************/
function cp() {
LineColor = UI.GetColor( "Script Items" , "Lines Color" )
TextColor = UI.GetColor( "Script Items" , "Text Color" )
BackColor = UI.GetColor( "Script Items" , "Background Color" )
BarColor = UI.GetColor( "Script Items" , "Slider Color" )

if(LineColor[0] == 0 && LineColor[1] == 0 && LineColor[2] == 0){
    LineColor[0] = 255
    LineColor[1] = 255
    LineColor[2] = 255
}
...
if(BarColor[0] == 0 && BarColor[1] == 0 && BarColor[2] == 0){
    BarColor[0] = 255
    BarColor[1] = 255
    BarColor[2] = 255
}
if(BackColor[0] == 0 && BackColor[1] == 0 && BackColor[2] == 0 && BackColor[3] == 0){
    BackColor[0] = 0
    BackColor[1] = 0
    BackColor[2] = 0
    BackColor[3] = 150
...
Menu.prototype.draw = function() {
	...
	for (var i in this.elements) {
		...
		Render.FilledRect(this.x, this.y + current * this.height, this.width, this.height, [BackColor[0], BackColor[1], BackColor[2], BackColor[3]]);
	...
	Render.FilledRect(this.x, this.y, this.width, this.height, [BackColor[0], BackColor[1], BackColor[2], BackColor[3]]);

	Render.Rect(this.x, this.y, this.width, this.height, [LineColor[0], LineColor[1], LineColor[2], 255]);

	Render.Rect(this.x, this.y, this.width, current * this.height, [LineColor[0], LineColor[1], LineColor[2], 255]);

	Render.StringCustom(this.x+5, this.y+this.height/2-Render.TextSizeCustom("!", this.font)[1]/2, 0, this.title, [TextColor[0], TextColor[1], TextColor[2], 255], this.font);
...
Button.prototype.draw = function(x, y) {
	...
	Render.Rect(x+this.x, y+this.y, this.width, this.height, [LineColor[0], LineColor[1], LineColor[2], 255]);

	this.text && Render.StringCustom(x+this.x+this.width/2, y+this.y+this.height/2-Render.TextSizeCustom("!", this.parent.font)[1]/2, 1, this.text, [TextColor[0], TextColor[1], TextColor[2], 255], this.parent.font);
...
Checkbox.prototype.draw = function(x, y) {
	...
	this.text && Render.StringCustom(x+this.text[0], y+this.y+this.height/2-Render.TextSizeCustom("!", this.parent.font)[1]/2, this.text[1], this.text[2], [TextColor[0], TextColor[1], TextColor[2], 255], this.parent.font);
...
Selector.prototype.draw = function(x, y) {
	...
	Render.Rect(x+this.x+this.height+2, y+this.y, this.width, this.height, [LineColor[0], LineColor[1], LineColor[2], 255]);

	Render.StringCustom(x+this.x+this.height+2+this.width/2, y+this.y+this.height/2-Render.TextSizeCustom("!", this.parent.font)[1]/2, 1, this.memory.options[this.memory.selected], [TextColor[0], TextColor[1], TextColor[2], 255], this.font);
...
Dropdown.prototype.draw = function(x, y) {
	...
	Render.Rect(x+this.parent.width-this.width-this.parent.height+1, y, this.width, this.parent.height, [LineColor[0], LineColor[1], LineColor[2], 255]);

	Render.StringCustom(x+this.parent.width-this.width/2-this.parent.height+1, y+this.parent.height/2-Render.TextSizeCustom("!", this.parent.font)[1]/2, 1, this.memory.options[this.memory.selected], [TextColor[0], TextColor[1], TextColor[2], 255], this.font);

	this.text && Render.StringCustom(x+this.text[0], y+this.parent.height/2-Render.TextSizeCustom("!", this.parent.font)[1]/2, this.text[1], this.text[2], [TextColor[0], TextColor[1], TextColor[2], 255], this.parent.font);
...
Slider.prototype.draw = function(x, y) {
	...
	Render.FilledRect(x+this.parent.width-this.width+1, y, ((this.memory.val+(this.memory.min < 0 ? this.memory.max : 0))/(Math.abs(this.memory.min)+Math.abs(this.memory.max)))*this.width, this.parent.height, [BarColor[0], BarColor[1], BarColor[2], 95]);

	Render.StringCustom(x+this.parent.width-this.width+this.width/2, y+this.parent.height/2-Render.TextSizeCustom("!", this.parent.font)[1]/2, 1, this.memory.val+"", [TextColor[0], TextColor[1], TextColor[2], 255], this.parent.font);
...
function onDraw() {
	...
	if (options[UI.GetValue("menu type")].showArrows.toggled && options[UI.GetValue("menu type")].style.memory.selected != 2) {
		...
		var colors = [[LineColor[0], LineColor[1], LineColor[2], 255], [LineColor[0], LineColor[1], LineColor[2], 255], [LineColor[0], LineColor[1], LineColor[2], 255]];
...
UI.AddColorPicker("Slider Color");
...
Cheat.RegisterCallback("Draw", "cp");
